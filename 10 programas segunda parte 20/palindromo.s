...
class Program
{
    static void Main()
    {
        ...
        // Llamada a la función para verificar si la cadena es palíndromo
    ...
    {
        // Eliminar espacios y convertir todo a minúsculas para una comparación insensible a mayúsculas
        string cleanStr = str.Replace(" ", "").ToLower();

        // Crear un array de caracteres y revertirlo
